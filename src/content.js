...
export const websiteTemplates = [
  { id: "commerce", category: "E-commerce", title: "Noir & Loom", subtitle: "Editorial fashion storefront", description: "A shoppable, responsive storefront with product browsing, collection filters, cart interactions, social proof, and a polished checkout path.", features: ["Working catalogue filters", "Interactive cart", "Responsive product grid", "Conversion-focused layout"], palette: ["#171512", "#d7a86e", "#f7f1e8"], layout: "commerce", live: "/?demo=commerce" },
  { id: "property", category: "Real estate", title: "Haven", subtitle: "Property discovery experience", description: "A high-trust property marketplace with real listing cards, location and budget filters, saved homes, agent contact, and viewing requests.", features: ["Searchable listings", "Budget filters", "Saved-property interaction", "Viewing enquiry flow"], palette: ["#123c36", "#dfb66d", "#eef4ef"], layout: "property", live: "/?demo=property" },
  { id: "saas", category: "SaaS", title: "PulseOps", subtitle: "Modern operations platform", description: "A complete product-marketing site with live dashboard preview, benefits, customer proof, pricing tiers, FAQ, and a focused signup journey.", features: ["Product dashboard preview", "Pricing switch", "Expandable FAQs", "Responsive SaaS landing page"], palette: ["#111525", "#8c7cff", "#e9ff79"], layout: "saas", live: "/?demo=saas" },
];
